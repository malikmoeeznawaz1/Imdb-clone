...
const Carousel = () => {
    ...
    const SampleNextArrow = (props) => {
        ...
        return (
            <button
                onClick={onClick}
                className="absolute right-1 top-1/2 transform -translate-y-1/2 z-10 bg-black/10 text-white rounded-sm border border-slate-100 py-8 w-12 h-12 lg:flex items-center justify-center transition duration-300 cursor-pointer hover:text-[#F5C518] hidden"
            >
    ...
    return (
        <div className="w-full h-full flex items-center justify-center relative hover:cursor-pointer hover:brightness-90 transition duration-200 ease-in-out ">
